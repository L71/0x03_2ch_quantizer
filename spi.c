...
void spi_write_word(uint16_t data) {	 // int 0-4095
...
void spi_write_word_cha(uint16_t data) {
	spi_write_word(data | 0x1000);
}

void spi_write_word_chb(uint16_t data) {
	spi_write_word(data | 0x9000);
}
